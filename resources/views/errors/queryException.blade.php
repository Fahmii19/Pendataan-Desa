            ...
            <div class="h-full w-[40vw]">
                <div>
                    <h2 class="text-center text-3xl font-bold">
                        Maaf ada gangguan layanan Pintoinvest
                    </h2>
                </div>
                <div class="text-center py-5">
                    <p class="mt-2 text-xl text-gray-500 leading-[2rem]">
                        Beban server Pintoinvest sedang tinggi melebihi kapasitas yang
                        ada. Mohon kesediaannya untuk bersabar menunggu sesaat
                    </p>
