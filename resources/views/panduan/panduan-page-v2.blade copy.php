...
<head>
    ...
    <style>
        /* @font-face {
            ...
            src: url('{{ asset('assets/LiberationSerif-Regular.ttf') }}') format('truetype');
        } */
        ...
        .scrollbar-panduan::-webkit-scrollbar-track-piece:end {
            background: transparent;
            margin-bottom: 0rem;
        }

        .scrollbar-panduan::-webkit-scrollbar-track-piece:start {
            background: transparent;
            margin-top: -1.2rem;
        }

        .scrollbar-panduan::-webkit-scrollbar {
            width: 8px;
            height: 10px;
        }

        .scrollbar-panduan::-webkit-scrollbar-track {
            border-radius: 100vh;
            background: blue;
            display: none;
        }

        .scrollbar-panduan::-webkit-scrollbar-thumb {
...
<body class="font-['Arial']">
    ...
    <div class="flex flex-row h-screen overflow-hidden">
        ...
        <div class="basis-[20rem] bg-[#102037] w-full pb-5 pl-4 pr-2">
            ...
            {{-- Judul --}}
            <div class="grid grid-cols-3 py-5 hidden">
                <div class="col-span-2">
                    <span class="font-bold text-[14pt] cursor-pointer text-gray-300">Sistem JakPintas</span>
                </div>
                {{-- Tombol untuk aksi form didisable --}}
                <div class="grid hidden">
                    @role('admin')
                    <div class="place-self-end cursor-pointer text-gray-300" data-modal-toggle="modal-input-menu">
            ...
            <div class="flex flex-row py-4">
                <a href="#" class="flex items-center">
                    ...
                    <div class="flex flex-col">
                        <div>
                            <span class="self-center lg:text xl:text-xl font-semibold text-gray-300">Panduan
                                Pintoinvest</span>
                        </div>
            ...
            <div class="flex flex-col h-[90vh] overflow-x-hidden scrollbar-panduan scrollbar-firefox -mr-2 pr-2 pb-5">
                ...
                <div id="accordion-flush" data-active-classes="bg-white dark:bg-[#102037] text-blue-500" data-inactive-classes="text-gray-500">
                    ...
                    <div id="accordion-flush-heading-1" class="accordion-header flex flex-row text-gray-300">
                        <div type="button" id="active_title_mengenal" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                            <a class="navigation" href="#mengenal-pintoinvest" onclick="ArrowActiveMenuPanduan(1)">
                                <div class="text-gray-300 scroll_active sub_mengenal active_mengenal pr-4">Mengenal
                                    Pintoinvest</div>
                        ...
                        <div id="accordion-flush-body-2" class="hidden hide_show_panduan_pintoinvest" aria-labelledby="accordion-flush-heading-2">
                            <div class="grid_subjudul pl-6 text-sm" id="sub_active_pintoinvest">
                                ...
                                <a class="navigation" href="#login-akun" onclick="ActiveMenuPanduan(2)">
                                    <div class="text-gray-300 sub_pintoinvest scroll_active active_pintoinvest pr-4">
                                        Login</div>
                                </a>
                                ...
                                <a class="navigation" href="#penamaan-komponen" onclick="ActiveMenuPanduan(2)">
                                    ...
                                    <div class="text-gray-300 sub_pintoinvest scroll_active pr-4">Penamaan komponen
                                    </div>

                                </a>
                                <a class="navigation" href="#informasi-spasial" onclick="ActiveMenuPanduan(2)">

                                    <div class="text-gray-300 sub_pintoinvest scroll_active pr-4">Menggunakan Search Box
                                    </div>
                    ...
                    {{-- Layer Informasi Spasial --}}
                    <div>
                        <div id="accordion-flush-heading-12" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_informasi_spasial" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_informasi_spasial" onclick="ActiveMenuPanduan(12)">Layer Informasi Spasial</span>
                            </div>

                            <span class="" onclick="ArrowActiveMenuPanduan(12)">
                                <svg data-accordion-icon class="w-5 h-5 shrink-0 cursor-pointer rotasi_open_informasi_spasial" id="accordion-12" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="accordion-flush-body-12" class="hidden hide_show_panduan_informasi_spasial" aria-labelledby="accordion-flush-heading-12">
                            <div class="grid_subjudul pl-6 text-sm" id="sub_active_informasi_spasial">
                                <a href="#zonasi" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial active_informasi_spasial scroll_active">
                                        Zonasi</div>

                                </a>
                                <a href="#batas-rw" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Batas RW</div>
                                </a>
                                <a href="#transect-zone" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Transect Zone</div>
                                </a>
                                <a href="#garis-kepulauan" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Garis Kepulauan</div>
                                </a>
                                <a href="#area-kepulauan" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Area Kepulauan</div>
                                </a>
                                <a href="#kawasan-khusus" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Kawasan Khusus</div>
                                </a>
                                <a href="#batas-laut" onclick="ActiveMenuPanduan(12)">
                                    <div class="text-gray-300 sub_informasi_spasial scroll_active">Batas Laut</div>
                                </a>
                                <a href="#obyek-laut" onclick="ActiveMenuPanduan(12)">
                    ...
                    <div>
                        <div id="accordion-flush-heading-3" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_kompilasi" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_kompilasi" onclick="ActiveMenuPanduan(3)">Membaca
                                    kompilasi informasi spasial</span>
                            </div>

                            <span class="" onclick="ArrowActiveMenuPanduan(3)">
                                <svg data-accordion-icon class="w-5 h-5 shrink-0 cursor-pointer rotasi_open_kompilasi" id="accordion-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- <div id="accordion-flush-heading-4" class="accordion-header flex flex-row text-gray-300">
                        <div type="button" id="active_title_analisa"
                            class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm"
                            data-accordion-target="#" aria-expanded="false">
                            <a href="#analisa" onclick="ArrowActiveMenuPanduan(4)">
                                <div class="text-gray-300 sub_analisa active_analisa pr-4">Analisa prospek investasi
                                    PinToInvest</div>
                            </a>
                        </div>
                    </div> --}}
                        ...
                        <div id="accordion-flush-body-5" class="hidden hide_show_panduan_navigasi" aria-labelledby="accordion-flush-heading-5">
                            <div class="grid_subjudul pl-6 text-sm" id="sub_active_navigasi">
                                <a href="#peta-dasar" onclick="ActiveMenuPanduan(5)">
                                    <div class="text-gray-300 sub_navigasi active_navigasi scroll_active">Peta dasar
                                    </div>
                    ...
                    <div>
                        <div id="accordion-flush-heading-6" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_koneksi" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_koneksi" onclick="ActiveMenuPanduan(6)">Koneksi
                                    aplikasi perizinan lainnya</span>
                            </div>
                    ...
                    <div>
                        <div id="accordion-flush-heading-7" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_fitur" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_fitur" onclick="ActiveMenuPanduan(7)">Fitur
                                    Survey untuk pendataan</span>
                            </div>
                    ...
                    <div>
                        <div id="accordion-flush-heading-8" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_filter" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_filter" onclick="ActiveMenuPanduan(8)">Memfilter
                                    data dengan fitur chip</span>
                            </div>
                        ...
                        <div id="accordion-flush-body-8" class="hidden hide_show_panduan_filter" aria-labelledby="accordion-flush-heading-8">
                            <div class="grid_subjudul pl-6 text-sm" id="sub_active_filter">
                                ...
                                <a href="#verifikasi-wilayah" onclick="ActiveMenuPanduan(8)">
                                    <div class="text-gray-300 sub_filter scroll_active">Verifikasi Perkembangan Wilayah
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div id="accordion-flush-heading-9" class="accordion-header flex flex-row text-gray-300">
                        <div type="button" id="active_title_konsultasi" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                            <a href="#konsultasi-usaha" onclick="ArrowActiveMenuPanduan(9)">
                                <div class="text-gray-300 sub_konsultasi scroll_active active_konsultasi pr-4">Fitur
                                    Konsultasi</div>
                    ...
                    <div id="accordion-flush-heading-10" class="accordion-header flex flex-row text-gray-300">
                        <div type="button" id="active_title_cetak" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                            <a class="navigation" href="#cetak-report" onclick="ArrowActiveMenuPanduan(10)">
                                ...
                                <div class="text-gray-300 sub_cetak scroll_active active_cetak pr-4">Mencetak laporan
                                </div>
                    ...
                    {{-- Video --}}
                    <div>
                        <div id="accordion-flush-heading-13" class="accordion-header flex flex-row text-gray-300">
                            ...
                            <div type="button" id="active_title_video" class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm" data-accordion-target="#" aria-expanded="false">
                                <span class="cursor-default" id="arrow_video" onclick="ActiveMenuPanduan(13)">Video</span>
                            </div>

                            <span class="" onclick="ArrowActiveMenuPanduan(13)">
                                <svg data-accordion-icon class="w-5 h-5 shrink-0 cursor-pointer rotasi_open_video" id="accordion-13" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="accordion-flush-body-13" class="hidden hide_show_panduan_video" aria-labelledby="accordion-flush-heading-13">
                            <div class="grid_subjudul pl-6 text-sm" id="sub_active_video">
                                <a class="" href="#Video1" onclick="ActiveMenuPanduan(13)">
                                    <div class="text-gray-300 sub_video scroll_active active_video">
                                        Kasus 1
                                    </div>
                                </a>

                                <a class="" href="#Video2" onclick="ActiveMenuPanduan(13)">
                                    <div class="text-gray-300 sub_video scroll_active">
                                        Kasus 2
                                    </div>
                                </a>

                                <a class="" href="#Video3" onclick="ActiveMenuPanduan(13)">
                                    <div class="text-gray-300 sub_video scroll_active">
                                        Kasus 3
                                    </div>
                                </a>
                    ...
                    {{-- <div id="accordion-flush-heading-11" class="accordion-header flex flex-row text-gray-300">
                        <div type="button" id="active_title_referensi"
                            class="flex justify-between w-full font-normal text-left text-gray-300 outline-none text-sm"
                            data-accordion-target="#" aria-expanded="false">
                            <a href="#referensi-aplikasi" onclick="ArrowActiveMenuPanduan(11)">
                                <div class="text-gray-300 sub_referensi active_referensi pr-4">Referensi aplikasi lain
                                </div>
                            </a>
                        </div>
                    </div> --}}
            ...
            <!-- Main modal add -->
            <div id="modal-input-menu" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                <div class="relative w-full h-full max-w-2xl md:h-auto">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex items-start justify-between p-4 border-b rounded-t">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center " data-modal-toggle="modal-input-menu">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="{{ route('add-panduan') }}" method="POST">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="nama_judul" id="nama_judul" placeholder="Ketik disini">
                                </div>

                                <label class="block mb-2 text-sm font-medium text-gray-900 ">Kategori Judul</label>
                                <select class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-6" name="kategori">
                                ...
                                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" onclick="add_modal()">Kirim</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            {{-- Main modal update --}}
            <div id="modal-edit-menu" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                <div class="relative w-full h-full max-w-2xl md:h-auto">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow">
                        <!-- Modal header -->
                        <div class="flex items-start justify-between p-4 border-b rounded-t">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center " data-modal-toggle="modal-edit-menu">
                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                                <span class="sr-only">Close modal</span>
                        ...
                        <div class="p-6 space-y-6">
                            <form id="formUpdatePanduan">
                                ...
                                <div class="mb-6">
                                    <label class="block mb-2 text-sm font-medium text-black">Nama Judul</label>
                                    <input type="text" class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="nama_judul" id="edit_nama_judul" placeholder="Ketik disini">
                                </div>

                                <label class="block mb-2 text-sm font-medium text-gray-900 ">Kategori Judul</label>
                                <select class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-6" name="kategori" id="edit_kategori">
                                    <option value="" selected disabled hidden>Piih</option>
                                    <option value="Judul">Judul</option>
                                    <option value="SubJudul1">Sub Judul 1</option>
                                    <option value="SubJudul2">Sub Judul 2</option>
                                ...
                                <div class="mb-6">
                                    <label class="block mb-2 text-sm font-medium text-black">Penomoran</label>
                                    <input type="text" class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="penomoran" id="edit_penomoran" placeholder="Ketik disini">
                                </div>
        ...
        <div class="basis-[80rem] flex flex-col">

            <div class="flex flex-row justify-end py-3 px-6 group sticky top-0 bg-white hidden">

                <a target="_blank" href="{{ asset('pdf-panduan/PanduanPintoinvest.pdf') }}" class="">
            ...
            <div class="w-full scrollbar scrollbar-firefox overflow-y-auto overflow-x-auto flex flex-row" id="scroller">
                ...
                <div class="pl-40 pr-11">
                    ...
                    <div class="flex flex-col relative mt-2 mb-6 hidden" id="hideshowsearch">
                        ...
                        <div class="relative w-full flex items-center">
                            ...
                            <input type="text" id="search" class="bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Pencarian...">

                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">

                                {{-- Delete --}}
                                <div id="cancel-search" onclick="cancelSearch()">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="w-5 h-5 text-gray-500 hover:text-gray-900">
                        ...
                        <div class="max-h-[20rem] scrollbar overflow-y-auto overflow-x-hidden w-full bg-white rounded mt-2 py-4 absolute z-[99] top-10 hidden" id="container-result-search" style="display: block;">
                            {{-- <div
                                class="max-h-[20rem] scrollbar overflow-y-auto overflow-x-hidden w-full bg-gray-200 rounded mt-2 p-4 absolute z-[99] top-10 hidden"
                    ...
                    <div id="konten_panduan">
                        ...
                        {{-- Mengenal Aplikasi --}}
                        <div class="page-section get_number_panduan py-4" id="mengenal-pintoinvest" data-panduan="1" class="">
                        ...
                        <div class="">
                            ...
                            <div class="py-4 page-section" id="zonasi" data-panduan="12">
                            ...
                            <div class="py-4 page-section" id="batas-rw" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="transect-zone" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="garis-kepulauan" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="area-kepulauan" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="kawasan-khusus" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="batas-laut" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" id="obyek-laut" data-panduan="12">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                        ...
                        {{-- Membaca Kompilasi --}}
                        <div>
                            <div class="py-4 page-section" data-panduan="3" id="profil">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="ketentuan">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="kbli">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="indikator">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="sarpras">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="lingkungan">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="3" id="potensi">
                                <div class="komponen">
                        ...
                        <div>
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="peta-dasar">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="data-interaktif">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="zoom">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="tampilan">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="plot-shp">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="mengukur-jarak">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="mengukur-luas">
                                <div class="komponen">
                            ...
                            <div class="py-4 page-section" data-panduan="4" id="find-location">
                                <div class="komponen">
                        ...
                        {{-- Koneksi --}}
                        <div>
                            <div class="py-4 page-section" data-panduan="5" id="pesan-ajib">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" data-panduan="5" id="prapermohonan">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                        ...
                        {{-- fitur --}}
                        <div>
                            <div class="py-4 page-section" data-panduan="6" id="pengawasan">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" data-panduan="6" id="survey-perkembangan">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" data-panduan="6" id="pendataan-usaha">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-4 page-section" data-panduan="6" id="izin-lingkungan">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                        ...
                        <div>
                            ...
                            <div class="py-4 page-section" data-panduan="7" id="sewa-kantor">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="7" id="sebaran-nib">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="7" id="sebaran-umkm">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="7" id="cagar-budaya">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                            ...
                            <div class="py-4 page-section" data-panduan="7" id="verifikasi-wilayah">
                                <div class="komponen">
                                    <div class="py-2 tracking-wide text-[12pt]" id="off_content">
                        ...
                        {{-- Konsultasi --}}
                        <div class="pb-4 pt-6 page-section" data-panduan="8" id="konsultasi-usaha">
                        ...
                        {{-- Cetak --}}
                        <div class="page-section py-4 get_number_panduan" data-panduan="9" id="cetak-report">
                            <div class="komponen">
                                <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">
                            ...
                            <div class="py-6" id="konten_video">
                                ...
                                <div class="komponen">
                                    ...
                                    <div class="py-6 tracking-wide text-[12pt]" style="">
                                        ...
                                        <div class="py-14 page-section" data-panduan="13" id="Video1">
                                        ...
                                        <div class="py-14 mb-8 page-section" data-panduan="13" id="Video2">
                                        ...
                                        <div class="py-14 mb-8 page-section" data-panduan="13" id="Video3">
                        ...
                        {{-- referensi --}}
                        {{-- <div>
                                <div class="py-4" id="referensi-aplikasi">
                                    <div class="komponen">
                                        <div class="py-2 tracking-wide text-[12pt]" id="off_content" style="">

                                            <p class="font-semibold text-2xl">Referensi Aplikasi</p>

                                            <p class="mt-4">
                                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique
                                                eligendi rem tempore dolore? Numquam ducimus illum placeat sed, veniam
                                                eaque adipisci et cum, iusto fugiat saepe veritatis, quod a nulla! Lorem
                                                ipsum dolor sit, amet consectetur adipisicing elit. Veritatis, molestiae
                                                minus! Eum est ad laboriosam beatae ex. Consectetur eum ipsa iure
                                                quisquam dignissimos! Qui omnis, quam vitae maxime hic temporibus.
                                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique
                                                eligendi rem tempore dolore? Numquam ducimus illum placeat sed, veniam
                                                eaque adipisci et cum, iusto fugiat saepe veritatis, quod a nulla! Lorem
                                                ipsum dolor sit, amet consectetur adipisicing elit. Veritatis, molestiae
                ...
                <div class="sticky top-0 flex pt-4 pr-11">
                    <a target="_blank" href="{{ asset('pdf-panduan/PanduanPintoinvest.pdf') }}" class="">
