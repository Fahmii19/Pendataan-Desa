                    ...
                    <div class="row justify-content-start">
                        <div class="col-md-6 col-sm-12">
                            <div class="text-center">
                                <img src="{{ asset('assets/gambar/menu-utamav1-dokumen.png') }}" class="img-fluid" style="max-width: 500px;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12 bg_pdf_judul">
                    ...
                    <h3 class="p-2 fw-bold h5">
                        <img class="img_pdf_judul" src="{{ asset('assets/gambar/page/deskripsi.png') }}" alt="logo">Sektor</h3>
                </div>

                <ul class="list-group list-group-flush list-group-numbered">

                    <li class="list-group-item">
                        <a class="set_link" target="_blank" href="{{ asset('pdf-panduan/SektorKesehatan.pdf') }}">
                            <img class="img_pdf" src="{{ asset('assets/gambar/page/deskripsi.png') }}" alt="logo">
                            <span class="size_font"> Kesehatan</span>
                        </a>
                    </li>
