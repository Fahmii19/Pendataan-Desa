            ...
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="hide_lazyload_kinerja">
                            <div style="width: 8.5rem; height:1.8rem; border-radius:2px; position: relative; left:41rem;"
                                class="skeleton-image"></div>
                        </div>
                        ...
                        <div style="position: relative; left:-9rem;" class="card-actions w-25">
                            ...
                            <div class="hide_lazyload_kinerja">
                                <div style="width: 15rem; height:1.8rem; border-radius:2px position: relative;"
                                    class="skeleton-image"></div>
                            </div>
                    ...
                    {{-- <div class="col-md-2 ml-1 mt-1">
                        <a href="/dashboard/kinerja" target="_blank" id="PrintKinerja" class="btn w-50">
                            <!-- Download SVG icon from http://tabler-icons.io/i/rss -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-printer"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
