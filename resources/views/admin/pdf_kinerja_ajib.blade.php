    ...
    <table class="table table_custom" cell-spacing=0>
        ...
        <tr>
            ...
            <td style="width: 30%; padding: 0 0 0 0; margin-top:10rem;" rowspan="4">
                ...
                {{-- cara1 --}}
                {{-- <img style="position: absolute; width:11.8rem; max-height:150px; margin-top:5px;" src="https://jakarta.pintoinvest.com/mobile/img/{{ $dt->foto }}" /> --}}

                {{-- cara2 --}}
                <div><img style="top: 5px; left:6px;" src="https://jakarta.pintoinvest.com/mobile/img/{{ $dt->foto }}" /></div>

                {{-- cara3 --}}
                {{-- <div><img style="display:block;" width="95%" height="9rem;" src="https://jakarta.pintoinvest.com/mobile/img/{{ $dt->foto }}" /></div> --}}
            </td>
        </tr>
