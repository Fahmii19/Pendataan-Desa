            ...
            <div class="col-md-12 col-xl-12">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-header card-header-light">
                        <h3 class="card-title" style="font-size:14px; font-weight:400; letter-spacing:0.5px;">100 Data Input Terbaru</h3>
                        ...
                        <div class="container-fluid px-0">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    ...
                                    <div style="border-style: 2px #000 solid" class="gambar_utama_slider_input gambar_utama_slider_input_scale data_image_space">
                                    </div>
                                ...
                                <div sty class="col-md-6 mt-3">
                                    ...
                                    <div class="row box_kotak_wilayah">
                            ...
                            <div class="row jarak_inmobile" style="padding-left: 0.6%; padding-top:1.5%; padding-bottom:2.3%;">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <div style="max-height:8rem;" class="image_slider_input data_image_space2">
                                        ...
                                        @foreach ($slider_perkembangan as $gi)
                                        <div>
                                            <img class="img_child_survey img_child_id_perkembangan del_class_image" data-id="{{ $gi->id_baru }}" data-lazy="https://jakarta.pintoinvest.com/v1/survey/{{ count($gi->image) == 0 ? 'not_image.png' : $gi->image[0]->name }}">
                                        </div>
                                        @endforeach
        ...
        <div style="margin-top: 1rem" class="row-cards">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    <div class="card-status-top bg-success"></div>
                    <div class="card-header" style="padding-left:0.6%;">
                        <h3 class="card-title" style="font-size:14px; font-weight:400; letter-spacing:0.5px;">Detil Input Petugas Survey</h3>
                        <div class="card-actions" style="margin-top:0.6%; margin-right:-0.2%;">
        ...
        <div style="margin-top: 1rem" class="row-cards">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-header" style="padding-left: 0.6%;">
                        <h3 class="card-title" style="font-size:14px; font-weight:400; letter-spacing:0.5px;">Peta Perkembangan Wilayah</h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-surveyer2').DataTable({
            ...
            processing: true
            , serverSide: true
                // , ajax: "{{ url('/dashboard/get-kinerja-petugas') }}"
        ...
        $(document).ready(function() {
            $('#table-surveyer3').DataTable({
                ...
                processing: true
                , serverSide: true
                    // , ajax: "{{ url('/dashboard/get-view-survey') }}"
        ...
        //     processing: false
        //     , serverSide: true
        //     , ajax: "{{ url('/dashboard/get-progres-survey') }}"
