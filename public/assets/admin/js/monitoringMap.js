...
map.on("mouseenter", "titik-survey", (e) => {
    ...
    <div class="p-0">
        <div class="imgcard-container">
            <img src="https://jakarta.pintoinvest.com/img-survey/${data["foto"]}" class="card-img-top" style="width: 100%;height: 100px;object-fit: cover;">
        </div>
