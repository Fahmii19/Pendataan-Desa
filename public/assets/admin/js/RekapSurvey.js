function dataTebaruPerkembangan() {
    ...
    $.ajax({
        url: `/dashboard/fetch-perkembangan`,
        method: "GET",
        dataType: "json",
        ...
        success: function (e) {
            ...
            var datagambar = "";
            if (array.length == 0) {
                datagambar += `<div><img class="img_parents" src="https://jakarta.pintoinvest.com/v1/survey/not_image.png" alt="First slide"></div>`;
            } else {
                array.forEach((e) => {
                    datagambar += `<div><img class="img_parents" src="https://jakarta.pintoinvest.com/v1/survey/${e.name}" alt="First slide"></div>`;
                });
            }
            // console.log(array);
...
$(document).ready(function () {
    $(".img_child_id_perkembangan").on("click", function () {
        ...
        $.ajax({
            url: `/dashboard/perkembangan-terbaru/${id_data_terbaru}`,
            type: "get",
            dataType: "json",
            beforeSend: function () {
                $("#name_perkembangan").html(
            ...
            success: function (e) {
                ...
                if (array.length == 0) {
                    ...
                    array.forEach((e) => {
                        datagambar += `<div><img class="img_parents" style="width:490px !important;height: 300px; object-fit: cover;" src="https://jakarta.pintoinvest.com/v1/survey/${e.name}" alt="First slide"></div>`;
                    });
                }
