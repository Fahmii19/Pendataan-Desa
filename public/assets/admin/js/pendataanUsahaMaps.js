...
map.on("style.load", () => {
    map.addSource("titik-survey-rekap", {
        type: "geojson",
        data: `${APP_URL}/dashboard/titik-pendataan-usaha`,
    });
...
map.on("mouseenter", "titik-survey-rekap", (e) => {
    ...
    $.ajax({
        url: `/v1/dashboard/peta-pendataan-usaha/${id}`,
        method: "GET",
        dataType: "json",
        success: (e) => {
            ...
            var datagambar = "";
            if (array.length == 0) {
                datagambar += `<img class="img_parents" style="width: 100%;height: 100px;object-fit: cover;" src="https://jakarta.pintoinvest.com/v1/usaha/not_image.png" alt="First slide">`;
            } else {
                array.forEach((dataimage) => {
                    datagambar += `<img src="https://jakarta.pintoinvest.com/usaha/${dataimage.name}" class="card-img-top" style="width: 100%;height: 100px;object-fit: cover;">`;
                });
            }
            ...
            <div class="p-0">
                <div class="card-body p-2">
                    <h6 style="font-size:14px; line-height:17px; margin-bottom:7px" class="mt-0 card-title">${data["nama_usaha"]}</h6>
                    ...
                    <div style="line-height: 1.2;">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <span class="d-block"> ${data["pelaku"]}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="line-height: 1.2;">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <span class="d-block"> ${data["sektor"]}</span>
                                </div>
                            </div>
                        </div>
                </div>
