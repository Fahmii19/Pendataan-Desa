    ...
    i.prototype = {
        ...
        theme: function (e) {
            return void 0 === e
                ...
                : (console.log(
                  ...
                  this.$elementjFilestyle.addClass(
                      "jfilestyle-theme-" + this.options.theme
                  ),
                  void 0);
        },
        inputSize: function (e) {
            return void 0 === e
                ...
                : ((this.options.inputSize = e),
                  void this.$elementjFilestyle
                      .find(":text")
                      .css("width", this.options.inputSize));
        },
        ...
        constructor: function () {
            var i = this,
                ...
                l = i.$element.attr("id");
            ("" !== l && l) ||
                ((l = "jfilestyle-" + t), i.$element.attr({ id: l }), t++),
                (n =
                ...
                (i.$elementjFilestyle = e(
                    '<div class="jfilestyle ' +
                        ...
                        " " +
                        (this.options.buttonBefore
                            ? " jfilestyle-buttonbefore"
                            : "") +
                        " " +
                        (i.options.theme
                            ? "jfilestyle-theme-" + i.options.theme
                            : "") +
                ...
                i.$elementjFilestyle
                    ...
                    .keypress(function (e) {
                        return 13 === e.keyCode || 32 === e.charCode
                            ? (i.$elementjFilestyle.find("label").click(), !1)
                            : void 0;
                    }),
                i.$element
                    .css({
                ...
                i.$elementjFilestyle.find('[name="filedrag"]').css({
                    position: "absolute",
                    width: "100%",
                ...
                i.$element.change(function () {
                    ...
                    0 == i.options.input
                        ? 0 ==
                          i.$elementjFilestyle.find(".count-jfilestyle").length
                            ? i.$elementjFilestyle
                                  .find("label")
                                  .append(
                                      ' <span class="count-jfilestyle">' +
                ...
                i.$elementjFilestyle
                    ...
                    .on("drop", function (t) {
                        if (
                            ...
                            0 == i.options.input
                                ? 0 ==
                                  i.$elementjFilestyle.find(".count-jfilestyle")
                                      .length
                                    ? i.$elementjFilestyle
                                          .find("label")
                                          .append(
        ...
        var l = "",
            s = this.each(function () {
                if ("file" === e(this).attr("type")) {
                    ...
                    o ||
                        (s.data("jfilestyle", (o = new i(this, a))),
                        o.constructor()),
                        "string" == typeof t && (l = o[t](n));
                }
            });
