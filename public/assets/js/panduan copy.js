...
function setActiveMenuItem() {
    ...
    menuItems.forEach((item, index) => {
        ...
        // Jika section dalam view dan isActiveSectionFound masih false
        if (rect.top <= 5 && rect.bottom >= 50 && !isActiveSectionFound) {
            ...
            // Check if activePanduan is a valid number
            if (!isNaN(activePanduan) && activePanduan !== null) {
                if (activePanduan !== lastActivePanduan) {
                    // Reset semua class dan content panduan
                    resetPanduan();

                    switch (activePanduan) {
                        case 1:
                            activatePanduan1();
                            break;
                        case 2:
...
function resetPanduan() {
    // Reset semua rotasi dan content panduan
...
function activatePanduan1() {
    // Aktivasi panduan 1
    $(".rotasi_open_pintoinvest").removeClass("rotate-180");
    $(".rotasi_open_informasi_spasial").removeClass("rotate-180");
    $(".rotasi_open_kompilasi").removeClass("rotate-180");
    $(".rotasi_open_navigasi").removeClass("rotate-180");
    $(".rotasi_open_koneksi").removeClass("rotate-180");
    $(".rotasi_open_fitur").removeClass("rotate-180");
    $(".rotasi_open_filter").removeClass("rotate-180");
    $(".rotasi_open_video").removeClass("rotate-180");

    // Content Panduan

    $(".hide_show_panduan_pintoinvest").hide();
    $(".hide_show_panduan_informasi_spasial").hide();
    $(".hide_show_panduan_kompilasi").hide();
    $(".hide_show_panduan_navigasi").hide();
    $(".hide_show_panduan_koneksi").hide();
    $(".hide_show_panduan_fitur").hide();
    $(".hide_show_panduan_filter").hide();
    $(".hide_show_panduan_video").hide();

    // console.log("pintoinvest");
}
...
function activatePanduan2() {
    ...
    // console.log("Memulai Pintoinvest");
}
...
function activatePanduan3() {
    ...
    // console.log("Membaca Kompilasi");
}

// Asumsi bahwa 'scroller' sudah didefinisikan
scroller.addEventListener("scroll", setActiveMenuItem);

const ArrowActiveMenuPanduan = (param) => {
    // Menu Mengenal
    if (param == 1) {
        // console.log("Mengenal");
        $(".active_mengenal").removeClass("text-gray-300");
        $(".active_mengenal").addClass("text-blue-500");

        // Set warna aktif pada sub menu
        $("#active_title_mengenal").on("click", ".sub_mengenal", function () {
            $(".sub_mengenal.text-blue-500").removeClass("text-blue-500");
            $(".sub_mengenal").removeClass("active_mengenal");
            $(this).addClass("text-blue-500");

            // Set menghapus warna aktif pada sub menu
            $(".sub_pintoinvest").removeClass("text-blue-500");
            $(".sub_kompilasi").removeClass("text-blue-500");
            $(".sub_informasi_spasial").removeClass("text-blue-500");
            $(".sub_analisa").removeClass("text-blue-500");
            $(".sub_navigasi").removeClass("text-blue-500");
            $(".sub_koneksi").removeClass("text-blue-500");
            $(".sub_fitur").removeClass("text-blue-500");
            $(".sub_filter").removeClass("text-blue-500");
            $(".sub_konsultasi").removeClass("text-blue-500");
            $(".sub_cetak").removeClass("text-blue-500");
            $(".sub_referensi").removeClass("text-blue-500");
            $(".sub_video").removeClass("text-blue-500");
        ...
        console.log("Pintoinvest Klik");

        $("#sub_active_pintoinvest").on(
            "click",
            ".sub_pintoinvest",
            function () {
                // Menghapus kelas text-blue-500 dari elemen .sub_pintoinvest selain yang sedang diklik
                $("#sub_active_pintoinvest .sub_pintoinvest")
                    .not(this)
                    .removeClass("text-blue-500");
                // Menghapus kelas active_pintoinvest dari elemen #sub_active_pintoinvest .sub_pintoinvest selain yang sedang diklik
                $("#sub_active_pintoinvest .sub_pintoinvest")
                    .not(this)
                    .removeClass("active_pintoinvest");

                // Menambahkan kelas text-blue-500 pada elemen yang sedang diklik
                $(this).addClass("text-blue-500");

                // Set menghapus warna aktif pada sub menu
                $(".sub_mengenal").removeClass("text-blue-500");
                $(".sub_kompilasi").removeClass("text-blue-500");
                $(".sub_informasi_spasial").removeClass("text-blue-500");
                $(".sub_analisa").removeClass("text-blue-500");
                $(".sub_navigasi").removeClass("text-blue-500");
        ...
        $(".hide_show_panduan_pintoinvest").removeClass("hidden");
        $(".rotasi_open_pintoinvest").toggleClass("rotate-180");
        ...
        $("#sub_active_kompilasi").on("click", ".sub_kompilasi", function () {
            // Menghapus kelas text-blue-500 dari elemen .sub_pintoinvest selain yang sedang diklik
            $("#sub_active_kompilasi .sub_kompilasi")
                .not(this)
                .removeClass("text-blue-500");
            // Menghapus kelas active_kompilasi dari elemen #sub_active_kompilasi .sub_kompilasi selain yang sedang diklik
            $("#sub_active_kompilasi .sub_kompilasi")
                .not(this)
                .removeClass("active_kompilasi");
            ...
            $(".sub_mengenal").removeClass("text-blue-500");
            $(".sub_pintoinvest").removeClass("text-blue-500");
            // $(".sub_kompilasi").addClass("text-blue-500");
            $(".sub_informasi_spasial").removeClass("text-blue-500");
            $(".sub_analisa").removeClass("text-blue-500");
            $(".sub_navigasi").removeClass("text-blue-500");
            $(".sub_koneksi").removeClass("text-blue-500");
        ...
        // Fungsi Button Collapse
        $(".hide_show_panduan_kompilasi").removeClass("hidden");
        $(".rotasi_open_kompilasi").toggleClass("rotate-180");
