!(function (t, e) {
    ...
    var i = {
        ...
        s = { HOT: "mapbox-gl-draw-hot", COLD: "mapbox-gl-draw-cold" },
        u = {
            ADD: "add",
            MOVE: "move",
            DRAG: "drag",
        ...
        c = { POLYGON: "polygon", LINE: "line_string", POINT: "point" },
        l = {
            FEATURE: "Feature",
            POLYGON: "Polygon",
        ...
        g = { FEATURE: "feature", MIDPOINT: "midpoint", VERTEX: "vertex" },
        y = { ACTIVE: "true", INACTIVE: "false" },
        m = [
            "scrollZoom",
            "boxZoom",
            "dragRotate",
        ...
        v = -85,
        _ = 85,
        b = { Point: 0, LineString: 1, Polygon: 2 };
    function E(t, e) {
    ...
    function I(t, e) {
        ...
        return (
            n[0] &&
                ((r.mouse =
                    n[0].properties.active === y.ACTIVE ? u.MOVE : u.POINTER),
                (r.feature = n[0].properties.meta)),
    ...
    var U = R(function (t) {
            var e = (t.exports = function (t, n) {
                if ((n || (n = 16), void 0 === t && (t = 128), t <= 0))
                    return "0";
                for (
                    var r = Math.log(Math.pow(2, t)) / Math.log(n), o = 2;
                    r === 1 / 0;
                    o *= 2
                )
                    r = (Math.log(Math.pow(2, t / o)) / Math.log(n)) * o;
    ...
    var G = { MultiPoint: D, MultiLineString: V, MultiPolygon: B },
        $ = function (t, e, n, r, o) {
            var i = n.split("."),
                a = parseInt(i[0], 10),
    ...
    ((J.prototype = Object.create(j.prototype))._coordinatesToFeatures =
        function (t) {
            var e = this,
        ...
        (J.prototype.updateCoordinate = function (t, e, n) {
            $(this.features, "updateCoordinate", t, e, n), this.changed();
        }),
        (J.prototype.addCoordinate = function (t, e, n) {
            $(this.features, "addCoordinate", t, e, n), this.changed();
        }),
        (J.prototype.removeCoordinate = function (t) {
            $(this.features, "removeCoordinate", t), this.changed();
        }),
    ...
    function X() {
        ...
        if (
            ...
            i &&
                t.ctx.map.getSource(s.COLD).setData({
            ...
            t._emitSelectionChange &&
                (t.ctx.map.fire(p.SELECTION_CHANGE, {
            ...
            (t._deletedFeaturesToEmit = []),
                t.ctx.map.fire(p.DELETE, { features: u });
        }
        function c() {
            (t.isDirty = !1), t.clearChangedIds();
        }
        c(), t.ctx.map.fire(p.RENDER, {});
    }
    function Z(t) {
        var e,
            n = this;
            ...
            return (
                ...
                H(t).forEach(function (t) {
                    n._featureIds.has(t) &&
                        ...
                        e.silent ||
                            (-1 ===
                                n._deletedFeaturesToEmit.indexOf(
                                    n._features[t]
                                ) &&
            ...
            o = {
                ...
                onAdd: function (i) {
                    ...
                    return (
                        ...
                        (e.map = i),
                        (e.events = (function (e) {
                            var n = Object.keys(e.options.modes).reduce(
                                    function (t, n) {
                                        return (
                            ...
                            function l(r, o, i) {
                                ...
                                (s = t(c, e)),
                                    i.silent ||
                                        e.map.fire(p.MODE_CHANGE, { mode: r }),
                                    e.store.setDirty(),
                                    e.store.render();
                            }
                            (i.keydown = function (t) {
                                "mapboxgl-canvas" ===
                                    (t.srcElement || t.target).classList[0] &&
                                    ((8 !== t.keyCode && 46 !== t.keyCode) ||
                                    !e.options.controls.trash
                                        ? c(t.keyCode)
                                            ? s.keydown(t)
                                            : 49 === t.keyCode &&
                                              e.options.controls.point
                                            ? l(h.DRAW_POINT)
                                            : 50 === t.keyCode &&
                                              e.options.controls.line_string
                                            ? l(h.DRAW_LINE_STRING)
                                            : 51 === t.keyCode &&
                        ...
                        (e.ui = (function (t) {
                            ...
                            function l() {
                                n &&
                                    (n.classList.remove(a.ACTIVE_BUTTON),
                                    (n = null));
                            }
                            function p(t) {
                                l();
                                ...
                                r &&
                                    r &&
                                    "trash" !== t &&
                                    (r.classList.add(a.ACTIVE_BUTTON), (n = r));
                            }
                            return {
                                setActiveButton: p,
                                queueMapClasses: i,
                                    ...
                                    return (
                                        ...
                                        n
                                            ? (n[c.LINE] &&
                                              ...
                                              n[c.POLYGON] &&
                                                  (e[c.POLYGON] = u(c.POLYGON, {
                                                      container: r,
                                                      className:
                                                          a.CONTROL_BUTTON_POLYGON,
                                                      title:
                                                          "Polygon tool " +
                                                          (t.options.keybindings
                                                              ? "(p)"
                                              ...
                                              n.combine_features &&
                                                  (e.combine_features = u(
                                                      "combineFeatures",
                                                      {
                                                          container: r,
                                                          className:
                                                              a.CONTROL_BUTTON_COMBINE_FEATURES,
                                                          title: "Combine",
                                                          onActivate:
                                                              function () {
                                              ...
                                              n.uncombine_features &&
                                                  (e.uncombine_features = u(
                                                      "uncombineFeatures",
                                                      {
                                                          container: r,
                                                          className:
                                                              a.CONTROL_BUTTON_UNCOMBINE_FEATURES,
                                                          title: "Uncombine",
                                                          onActivate:
                                                              function () {
                ...
                addLayers: function () {
                    e.map.addSource(s.COLD, {
                        data: { type: l.FEATURE_COLLECTION, features: [] },
                        type: "geojson",
                    }),
    ...
    function ot(t) {
        return (
            ...
            t.featureTarget.properties.active === y.ACTIVE &&
            t.featureTarget.properties.meta === g.FEATURE
        );
    }
    function it(t) {
        return (
            !!t.featureTarget &&
            !!t.featureTarget.properties &&
            t.featureTarget.properties.active === y.INACTIVE &&
            t.featureTarget.properties.meta === g.FEATURE
        );
    }
    function at(t) {
    ...
    function ft(t, e, n, r) {
        return {
            ...
            geometry: { type: l.POINT, coordinates: e },
        };
    }
    function gt(t, e, n) {
        ...
        return (
            i === l.POINT
                ...
                : i === l.LINE_STRING
                ? c(a, n)
                : 0 === i.indexOf(l.MULTI_PREFIX) &&
                  ((r = i.replace(l.MULTI_PREFIX, "")),
            ...
            var e = (function t(e) {
                    switch ((e && e.type) || null) {
                        case "FeatureCollection":
                            return (
                                (e.features = e.features.reduce(function (
                                    e,
                                    n
                                ) {
                                    return e.concat(t(n));
    ...
    function kt(t, e) {
        ...
        t.forEach(function (t) {
            ...
            t.type === l.POINT
                ? (e = o(r))
                : t.type === l.LINE_STRING || t.type === l.MULTI_POINT
                ? (e = r.map(o))
                : t.type === l.POLYGON || t.type === l.MULTI_LINE_STRING
                ? (e = r.map(i))
                : t.type === l.MULTI_POLYGON &&
                  (e = r.map(function (t) {
                      return t.map(function (t) {
                          return i(t);
                      });
    ...
    (Rt.onTap = Rt.onClick =
        ...
        (Rt.clickOnFeature = function (t, e) {
            var n = this;
            mt(this), this.stopExtendedInteractions(t);
            var r = ut(e),
                o = this.getSelectedIds(),
                i = e.featureTarget.properties.id,
                a = this.isSelected(i);
            if (!r && a && this.getFeature(i).type !== l.POINT)
            ...
            a && r
                ? (this.deselect(i),
                  ...
                  1 === o.length && yt(this))
                : !a && r
                ? (this.select(i), this.updateUIClasses({ mouse: u.MOVE }))
                : a ||
                  r ||
        ...
        (Rt.whileBoxSelect = function (t, e) {
            (t.boxSelecting = !0),
                ...
                t.boxSelectElement ||
                    ...
                    t.boxSelectElement.classList.add(a.BOX_SELECT),
        ...
        (Rt.dragMove = function (t, e) {
            ...
            kt(this.getSelected(), n), (t.dragMoveLocation = e.lngLat);
        }),
        (Rt.onMouseUp = function (t, e) {
            ...
            if (t.dragMoving) this.fireUpdate();
                ...
                var r = [
                        ...
                        dt(e.originalEvent, this.map.getContainer()),
                    ],
        ...
        (Rt.toDisplayFeatures = function (t, e, n) {
            (e.properties.active = this.isSelected(e.properties.id)
                ...
                n(e),
                this.fireActionable(),
                e.properties.active === y.ACTIVE &&
                    e.geometry.type !== l.POINT &&
                    gt(e).forEach(n);
        }),
        (Rt.onTrash = function () {
            ...
            if (!(0 === t.length || t.length < 2)) {
                ...
                if (n.length > 1) {
                    var a = this.newFeature({
                        ...
                        geometry: { type: "Multi" + r, coordinates: e },
                    });
                    this.addFeature(a),
        ...
        (Rt.onUncombineFeatures = function () {
            ...
            if (0 !== e.length) {
                for (
                    ...
                    o(i);
                n.length > 1 &&
                    this.map.fire(p.UNCOMBINE_FEATURES, {
                        createdFeatures: n,
                        deletedFeatures: r,
                    }),
                    this.fireActionable();
        ...
        Dt = {
            ...
            onVertex: function (t, e) {
                ...
                ut(e) || -1 !== r
                    ? ut(e) &&
                      -1 === r &&
                      t.selectedCoordPaths.push(n.coord_path)
                    : (t.selectedCoordPaths = [n.coord_path]);
                var o = this.pathsToCoordinates(
                    t.featureId,
                        ...
                        o = Ft(
                            r.map(function (t) {
                                return {
                                    type: l.FEATURE,
                                    properties: {},
                                    geometry: { type: l.POINT, coordinates: t },
                                };
                            }),
                            n
                        ),
            ...
            onSetup: function (t) {
                ...
                return (
                    this.setSelectedCoordinates(
                        this.pathsToCoordinates(e, r.selectedCoordPaths)
                    ),
                    this.setSelected(e),
                    mt(this),
            ...
            onStop: function () {
                yt(this), this.clearSelectedCoordinates();
            },
            toDisplayFeatures: function (t, e, n) {
                t.featureId === e.properties.id
                    ...
                    : ((e.properties.active = y.INACTIVE), n(e)),
    ...
    (Dt.onTouchStart = Dt.onMouseDown =
        function (t, e) {
            return Ut(e)
                ? this.onVertex(t, e)
                : ot(e)
    ...
    (Vt.onSetup = function () {
        var t = this.newFeature({
            type: l.FEATURE,
            properties: {},
            geometry: { type: l.POINT, coordinates: [] },
        });
        return (
            this.addFeature(t),
            this.clearSelectedFeatures(),
        ...
        (Vt.toDisplayFeatures = function (t, e, n) {
            ...
            if (((e.properties.active = r ? y.ACTIVE : y.INACTIVE), !r))
                return n(e);
        }),
    ...
    var Gt = {
        onSetup: function () {
            var t = this.newFeature({
                type: l.FEATURE,
                properties: {},
                geometry: { type: l.POLYGON, coordinates: [[]] },
            });
            return (
                this.addFeature(t),
                this.clearSelectedFeatures(),
        ...
        clickAnywhere: function (t, e) {
            if (
                ...
                Bt(e, t.polygon.coordinates[0][t.currentVertexPosition - 1])
            )
        ...
        onMouseMove: function (t, e) {
            t.polygon.updateCoordinate(
                ...
                st(e) && this.updateUIClasses({ mouse: u.POINTER });
        },
    };
    (Gt.onTap = Gt.onClick =
        function (t, e) {
    ...
    var $t = {
        onSetup: function (t) {
            ...
            if (r) {
                ...
                if (
                    e.coordinates[a][0] === i[0] &&
                    e.coordinates[a][1] === i[1]
                )
                    (n = a + 1),
                        e.addCoordinate.apply(e, [n].concat(e.coordinates[a]));
                else {
                    if (
                        e.coordinates[0][0] !== i[0] ||
                        e.coordinates[0][1] !== i[1]
                    )
                        throw new Error(
                ...
                (e = this.newFeature({
                    type: l.FEATURE,
                    properties: {},
                    geometry: { type: l.LINE_STRING, coordinates: [] },
                })),
                    (n = 0),
                    this.addFeature(e);
            return (
                ...
                this.setActionableState({ trash: !0 }),
                { line: e, currentVertexPosition: n, direction: o }
            );
        },
        clickAnywhere: function (t, e) {
            if (
                (t.currentVertexPosition > 0 &&
                    Bt(e, t.line.coordinates[t.currentVertexPosition - 1])) ||
    ...
    var Ht = R(function (t, e) {
        ...
        var G,
            ...
            H = Y.toString,
            X = q.hasOwnProperty,
            Z = (G = /[^.]+$/.exec((W && W.keys && W.keys.IE_PROTO) || ""))
                ? "Symbol(src)_1." + G
                : "",
            K = q.toString,
            Q = RegExp(
        ...
        function At(t) {
            ...
            for (var i in Object(t))
                X.call(t, i) && "constructor" != i && o.push(i);
            return o;
        }
        ...
        (St.prototype.clear = function () {
            ...
            (Tt.prototype.delete = function (t) {
                ...
                return (
                    !(n < 0) &&
                    (n == e.length - 1 ? e.pop() : ot.call(e, n, 1),
                    --this.size,
                    !0)
                );
            }),
        ...
        ((ct && Dt(new ct(new ArrayBuffer(1))) != I) ||
            (lt && Dt(new lt()) != g) ||
            (ht && "[object Promise]" != Dt(ht.resolve())) ||
            (pt && Dt(new pt()) != E) ||
            (dt && "[object WeakMap]" != Dt(new dt()))) &&
            (Dt = function (t) {
                var e = Mt(t),
        ...
        var $t = Nt(
                ...
                : function (t) {
                      return (
                          Ht(t) && X.call(t, "callee") && !rt.call(t, "callee")
                      );
                  },
            Jt = Array.isArray;
        var zt =
    ...
    function te() {
        for (
            var t = arguments, e = "", n = !1, r = arguments.length - 1;
            r >= -1 && !n;
            r--
        ) {
            var o = r >= 0 ? t[r] : "/";
    ...
    var re = {
        ...
        relative: function (t, e) {
            ...
            (t = te(t).substr(1)), (e = te(e).substr(1));
            for (
                var r = n(t.split("/")),
                    o = n(e.split("/")),
        ...
        join: function () {
            return ee(
                oe(Array.prototype.slice.call(arguments, 0), function (t, e) {
                    if ("string" != typeof t)
                        throw new TypeError(
    ...
    var ie =
        ...
        ae = R(function (t, e) {
            var n = (function () {
                var t = function (t, e, n, r) {
                                ...
                                case 17:
                                    (this.$ = i[s - 2]),
                                        void 0 !== i[s - 2][i[s][0]] &&
                                            ...
                                            this.$.__duplicateProperties__.push(
                                                i[s][0]
                                            )),
                                        (i[s - 2][i[s][0]] = i[s][1]);
                                    break;
                                            ...
                                            (x._$ = {
                                                first_line:
                                                    o[o.length - (T || 1)]
                                                        .first_line,
                                                last_line:
                                                    o[o.length - 1].last_line,
                                                first_column:
                                                    o[o.length - (T || 1)]
                                                        .first_column,
                                                last_column:
                                                    o[o.length - 1].last_column,
                                            }),
                                            y &&
                                                (x._$.range = [
                                                    o[o.length - (T || 1)]
                    ...
                    p = {
                        ...
                        next: function () {
                            ...
                            for (
                                var o = this._currentRules(), i = 0;
                                i < o.length;
                                i++
                            )
                                if (
                                    (n = this._input.match(this.rules[o[i]])) &&
                ...
                return (
                    (h.lexer = p), (d.prototype = h), (h.Parser = d), new d()
                );
            })();
            (e.parser = n),
                (e.Parser = n.Parser),
    ...
    ae.parser, ae.Parser, ae.parse, ae.main;
    function se(t) {
        return (t * Math.PI) / 180;
    }
    function ue(t) {
        ...
        if (t.length > 2)
            for (var n, r, o = 0; o < t.length - 1; o++)
                (n = t[o]),
                    (e +=
                        se((r = t[o + 1])[0] - n[0]) *
                        (2 + Math.sin(se(n[1])) + Math.sin(se(r[1]))));
        return e >= 0;
    }
    function ce(t) {
        if (t && t.length > 0) {
        ...
        hint: function (t, e) {
            ...
            function u(t, e, r) {
                ...
                if ("array" === r) {
                    ...
                    if ("object" === r && t[e] && t[e].constructor !== Object)
                        return n.push({
                            message:
                                '"' +
                                e +
            ...
            function c(t, a) {
                ...
                if (t.length > 3)
                    return n.push({
                        message:
                            "position should not have more than 3 elements",
                        level: "message",
                        line: t.__line__ || a,
                    });
                if (!s(t, "number"))
            ...
            function l(t, e, r, o) {
                if (
                    (void 0 === o && void 0 !== t.__line__ && (o = t.__line__),
                    0 === r)
                )
                    return c(t, o);
                if (1 === r && e)
            ...
            var f = {
                    ...
                    LineString: function (t) {
                        h(t),
                            p(t),
                            u(t, "coordinates", "array") ||
                                l(t.coordinates, "Line", 1);
                    },
                    MultiLineString: function (t) {
                        h(t),
                            p(t),
                            u(t, "coordinates", "array") ||
                                l(t.coordinates, "Line", 2);
                    },
                    ...
                    GeometryCollection: function (t) {
                        h(t),
                            p(t),
                            u(t, "geometries", "array") ||
                                (s(t.geometries, "object") ||
                                    n.push({
                                        message:
    ...
    function fe(t, e) {
        return (
            ...
            (e.getFeatureIdsAt = function (e) {
                return C.click({ point: e }, null, t).map(function (t) {
                    return t.properties.id;
                });
            }),
            ...
            (e.add = function (e) {
                ...
                var r = JSON.parse(JSON.stringify(vt(e))).features.map(
                    function (e) {
                        if (((e.id = e.id || U()), null === e.geometry))
            ...
            (e.delete = function (n) {
                return (
                    ...
                    t.store.getSelectedIds().length
                        ? t.store.render()
                        : t.events.changeMode(h.SIMPLE_SELECT, void 0, {
                              silent: !0,
                          }),
                    e
                );
                    ...
                    n === h.SIMPLE_SELECT && e.getMode() === h.SIMPLE_SELECT
                        ? ((o = r.featureIds || []),
                          ...
                          JSON.stringify(
                              ...
                              ? e
                              : (t.store.setSelected(r.featureIds, {
                                    silent: !0,
                                }),
                                t.store.render(),
                                e))
                        : n === h.DIRECT_SELECT &&
                          e.getMode() === h.DIRECT_SELECT &&
                          r.featureId === t.store.getSelectedIds()[0]
                        ? e
                        : (t.events.changeMode(n, r, { silent: !0 }), e)
                );
                var o, i;
            }),
            (e.getMode = function () {
            ...
            options: (t = (function (t) {
                ...
                return (
                    ...
                    !1 === t.displayControlsDefault
                        ? (e.controls = Q(qt, t.controls))
                        : (e.controls = Q(Yt, t.controls)),
                    ((e = Q(zt, e)).styles = Wt(e.styles, "cold").concat(
                        Wt(e.styles, "hot")
                    )),
                    e
                );
