...
use App\Http\Controllers\IUMKController;
use App\Http\Controllers\KajianLingkunganController;
...
use App\Http\Controllers\PesanAjib;
...
Route::get('/konsultasi', [PendataanUsahaController::class, 'ChatingPendataanUsaha'])->middleware('auth', 'timeout')->name('konsultasi');
Route::post('/ticketing', [PendataanUsahaController::class, 'save_ticket'])->middleware('auth', 'timeout')->name('ticketing');
//Upload File Chat
Route::post('/upload_file_chat', [PendataanUsahaController::class, 'uploadFileChat'])->name('upload-file-chat');
//Download File Chat
Route::get('/download_file/{name}', [PendataanUsahaController::class, 'downloadFileChat'])->name('download-file-chat');
...
Route::get('/print_word', [PrintController::class, 'print_word'])->name('print_word');
...
Route::post('/save_ketentuan', [PrintController::class, 'save_ketentuan'])->name('save-ketentuan');
// Route::post('/save_ketentuan', [PrintController::class, 'save_ketentuan_tpz'])->name('save-ketentuan-tpz');
...
Route::post('/save_lingkungan', [PrintController::class, 'save_lingkungan'])->name('save-lingkungan');
Route::post('/save_potensi', [PrintController::class, 'save_potensi'])->name('save-potensi');
Route::post('/check_print', [PrintController::class, 'check_print'])->name('check-print');
Route::get('/reset_check_print', [PrintController::class, 'reset_check_print'])->name('reset-check-print');

//Dokumen Dasar
Route::get('/dokumen-dasar-dan-panduan', [PagePDFController::class, 'Dokumen']);

// S&K Pintoinvest
Route::get('/s&k-pintoinvest', function () {
    return view('dokumen/sk-pintoinvest');
});

// Kebijakan Pintoinvest
Route::get('/kebijakan-pintoinvest', function () {
    return view('dokumen/kebijakan-privasi');
});
...
Route::prefix('panduan')->group(function () {
    Route::get('/', [PanduanController::class, 'panduan']);

    // update panduan
    Route::put('/{id}', [PanduanController::class, 'update']);
    // create panduan
    Route::post('/created-panduan', [PanduanController::class, 'add_panduan'])->name('add-panduan');
    // post panduan
    Route::get('/sub-judul/{id}', [PanduanController::class, 'sub_judul']);
    // upload File
    Route::post('/upload-file-panduan', [PanduanController::class, 'upload_image_content']);
    // delete judul panduan
    Route::delete('/delete-panduan/{id}', [PanduanController::class, 'delete_panduan']);

    // update judul panduan
    Route::get('/edit-panduan/{id}', [PanduanController::class, 'edit_panduan']);
    Route::put('/update-panduan/{id}', [PanduanController::class, 'update_panduan'])->name('update-panduan');

    Route::post('/{id}/{category}', [PanduanController::class, 'detail']);
    Route::get('/search/{keyword}', [PanduanController::class, 'search']);
});
...
//Admin Page
Route::prefix('/dashboard')->middleware(['auth', 'timeout', 'role:admin|super admin'])->group(function () {
    ...
    Route::post('/register', [UserController::class, 'add_register_user'])->name('add-register');
    Route::get('/ShowRegister/{id}', [UserController::class, 'show_register_user'])->name('show-register');
    Route::put('/register', [UserController::class, 'update_register_user'])->name('update-register');
    Route::delete('/register', [UserController::class, 'delete_register_user'])->name('delete-register');

    // Route::get('/pegawaiAjib', [UserController::class, 'pegawai_ajib'])->name('pegawai');
    // Route::post('/pegawaiAjib', [UserController::class, 'add_pegawai_ajib'])->name('add-pegawai');
    // Route::get('/ShowPegawaiAjib/{id}', [UserController::class, 'show_pegawai_ajib'])->name('show-pegawai');
    // Route::put('/pegawaiAjib', [UserController::class, 'update_pegawai_ajib'])->name('update-pegawai');
    // Route::delete('/pegawaiAjib', [UserController::class, 'delete_pegawai_ajib'])->name('delete-pegawai');
    ...
    Route::get('/survey-aksesibilitas-perkelurahan', [AdminController::class, 'aksesibilitas_perkelurahan'])->name('survey-aksesibilitas-perkelurahan');
    ...
    Route::get('export-aksesibilitas/{kel?}', [AdminController::class, 'pdf_aksesibilitas'])->name('export-aksesibilitas');
    ...
    Route::get('/perkembangan', [AdminController::class, 'perkembangan_survey'])->name('perkembangan-survey');

    Route::get('/lingkungan', [AdminController::class, 'izin_lingkungan'])->name('izin-lingkungan');

    Route::get('/kondisi', [AdminController::class, 'pengawasan_satu'])->name('pengawasan-satu');

    Route::get('/galian', [AdminController::class, 'pengawasan_dua'])->name('pengawasan-dua');
    Route::get('/dataPengawasanDua', [AdminController::class, 'dataPengawasanDua'])->name('data-pengawasan-dua');
    Route::get('/get-data-pengawasan', [AdminController::class, 'GetDataPengawasan'])->name('get-data-pengawasan');
    // Route::get('/laporan-data-pengawasan', [AdminController::class, 'ExportDataPengawasan'])->name('laporan-data-pengawasan');
    Route::get('/get-slider-pengawasan/{id}', [AdminController::class, 'GetSliderPengawasan'])->name('get-slider-pengawasan');
    // Route::get('Ekspor-Kinerja/{kelurahan?}', [AdminController::class, 'pdf_kinerja'])->name('ekspor-kinerja');
    Route::get('ekspor-pengawasan-dua/{kel?}', [AdminController::class, 'pdf_pengawasandua'])->name('ekspor-pengawasan-dua');
    Route::get('/peta-pengawasan', [AdminController::class, 'petaPengawasan'])->name('peta-pengawasan');
    Route::get('/peta-pengawasan-id/{id}', [AdminController::class, 'petaPengawasanID'])->name('peta-pengawasan-id');

    Route::get('/akses-terdaftar', [AdminController::class, 'ExportPengawasanDua'])->name('akses-terdaftar');





    // Export Izin Lingkungan
    Route::get('/export-izin-lingkungan', [AdminController::class, 'ExportIzinLingkungan'])->name('export-izin-lingkungan');
    // Route::get('/detil-input-cpns', [AdminController::class, 'ExportDetilInputCpns'])->name('detil-input-cpns');

    Route::get('/get-kinerja-cpns', [AdminController::class, 'KinerjaCpns'])->name('get-kinerja-cpns');
    Route::get('/get-view-detil-cpns', [AdminController::class, 'viewDetilCpns'])->name('get-view-detil-cpns');

    Route::get('/kinerja-cpns', [AdminController::class, 'ExportKinerjaCpns'])->name('kinerja-cpns');

    Route::get('/fetch-perkembangan', [AdminController::class, 'fetchPerkembangan'])->name('fetch-perkembangan');

    Route::get('/aksesibilitas', [AdminController::class, 'aksesibilitas'])->name('aksesibilitas');

    Route::get('/data-aksesibilitas', [AdminController::class, 'dataAksesibilitas'])->name('data-aksesibilitas');

    Route::get('/data-slider-aksesibilitas/{id_aksesibilitas}', [AdminController::class, 'dataSliderAksesibilitas'])->name('data-slider-aksesibilitas');

    Route::get('/get-data-peta-aksesibilitas', [AdminController::class, 'dataPetaAksesibilitas'])->name('get-data-peta-aksesibilitas');

    Route::get('/get-peta-aksesibilitas/{id}', [AdminController::class, 'PetaAksesibilitas'])->name('get-peta-aksesibilitas');

    Route::get('/get-kinerja-aksesibilitas', [AdminController::class, 'KinerjaAksesibilitas'])->name('get-kinerja-aksesibilitas');

    Route::get('/kinerja-petugas-aksesibilitas', [AdminController::class, 'ExportPetugasAksesibilitas'])->name('kinerja-petugas-aksesibilitas');
    ...
    // Pendataan Usaha
    Route::get('/usaha', [PendataanUsahaController::class, 'PendataanUsaha'])->name('pendataan_usaha');

    Route::get('/get-pendataan-usaha', [PendataanUsahaController::class, 'GetDataPendataanUsaha'])->name('get-pendataan-usaha');

    Route::get('/get-petugas-pendataan', [PendataanUsahaController::class, 'PetugasPendataan'])->name('get-petugas-pendataan');

    Route::get('/kinerja-petugas-pendataan', [PendataanUsahaController::class, 'ExportPetugasPendataan'])->name('kinerja-petugas-pendataan');

    Route::get('/detil-petugas-pendataan', [PendataanUsahaController::class, 'ExportDetilPendataan'])->name('detil-petugas-pendataan');

    Route::get('/get-detil-pendataan', [PendataanUsahaController::class, 'getDetilPendataan'])->name('get-detil-pendataan');

    Route::get('/titik-pendataan-usaha', [PendataanUsahaController::class, 'titikPendataanUsaha'])->name('titik-pendataan-usaha');
    Route::get('/peta-pendataan-usaha/{id}', [PendataanUsahaController::class, 'petaPendataan'])->name('peta-pendataan-usaha');





    Route::get('/slider-pendataan/{id_pendataan}', [PendataanUsahaController::class, 'GetPendataanSlider'])->name('slider-pendataan');

    Route::get('/user-register', [AdminController::class, 'userRegistrasi'])->name('user-register');

    // Aktivitas Login
    Route::get('/aktivitas-login-user', [AdminController::class, 'getAktivitasLogin'])->name('aktivitas-login-user');
});
...
Route::get('/progres-perkelurahan', function () {
    ...
    return view('dashboard/progres-perkelurahan', compact('data'));
})->name('progres-perkelurahan');

//Analytics Page
Route::get('/analytics/{periode}', [AnalyticsController::class, 'index']);
Route::get('/analytics/auth_log/{periode}', [AnalyticsController::class, 'auth_log']);

Route::post('/digitasi', [DigitasiController::class, 'index'])->name('digitasi');


//Survey Perkembangan
Route::get('/getDataSurvey/{id_survey}/{kelurahan}', [SurveyPerkembanganController::class, 'getDataSurvey'])->name('survey-perkembangan');
...
Route::get('/getListKelurahanSurvey', [SurveyPerkembanganController::class, 'getListKelurahanSurvey'])->name('get-list-kelurahan-survey');
...
//Kajian Lingkungan
Route::post('/saveKajian', [KajianLingkunganController::class, 'save_kajian'])->name('save-kajian');
Route::get('/getKajian', [KajianLingkunganController::class, 'get_kajian'])->name('get-kajian');
Route::post('/searchIzin', [KajianLingkunganController::class, 'search_izin'])->name('search-izin');
Route::post('/saveIzinLingkungan', [KajianLingkunganController::class, 'save_arsip_izin'])->name('save-arsip-izin');
Route::get('/get_data_izin', [KajianLingkunganController::class, 'get_data_izin'])->name('get-data-izin');
Route::post('/deleteFileArsip', [KajianLingkunganController::class, 'delete_arsip'])->name('delete-arsip');
Route::get('/get_list_kelurahan', [KajianLingkunganController::class, 'list_kelurahan'])->name('get-list-kelurahan');
Route::get('/get_list_nama_izin/{kelurahan}', [KajianLingkunganController::class, 'list_nama_izin'])->name('get-list-nama-izin');
Route::get('/get_nomor_permohonan/{kelurahan}/{nama_izin}', [KajianLingkunganController::class, 'list_nomor_permohonan'])->name('get-list-izin');
Route::get('/layer_izin_lingkungan', [KajianLingkunganController::class, 'layer_izin_lingkungan'])->name('layer-izin-lingkungan');

// IUMK
Route::post('/update_iumk', [IUMKController::class, 'update_iumk'])->name('update-iumk');

// Pesan Ajib
Route::prefix('/pesan-ajib')->group(function () {
    Route::post("/getListAjib", [PesanAjib::class, 'get_list_ajib'])->name('get-list-ajib');
    Route::post("/savePermohonan", [PesanAjib::class, 'save_permohonan'])->name('save-permohonan');
    Route::post("/getIzinAjib", [PesanAjib::class, 'get_izin_ajib'])->name('get-izin-ajib');
    Route::post("/getDataPermohonan", [PesanAjib::class, 'get_permohonan'])->name('get-permohonan');
    Route::post("/searchPermohonan", [PesanAjib::class, 'search_permohonan'])->name('get-permohonan');
});

//Update Session
Route::post('/update-session', function () {
    //Carbon get now without timezone
...
// NIB
Route::post('/saveNIB', [NibController::class, 'save_nib'])->name('save-nib');

// Form Pengahapusan Akun
Route::get('/delete_account', [UserController::class, 'delete_account'])->name('delete_account');
Route::post('/deleted_account', [UserController::class, 'deleted_account'])->name('deleted_account');
